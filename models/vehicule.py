class Vehicule:
    def __init__(self, id_vehicule, marque, modele, cylindree, 
                 kilometrage_actuel, date_mise_en_circulation):
    ...
    def __str__(self):
        return f"Véhicule {self.id_vehicule}: {self.marque} {self.modele}"
